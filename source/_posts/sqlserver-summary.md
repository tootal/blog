...
![](assets/20200605195745558_24675.webp)
...
![](assets/20200605195814359_30337.webp)


上面列出了版本的介绍和安装需要占用的空间以及下载的大小，可以根据自己的需要选择，我选择了Developer版本，下载好后直接双击开始安装。

![](assets/20200605195927111_17909.webp)

等待一段时间后就安装好了：

![](assets/20200605200308771_1693.webp)
...
![](assets/20200605201417179_19014.webp)


安装好后即可开始使用。

![](assets/20200605201904761_30296.webp)

服务器名称一般是计算机名称，可以在计算机--属性中查看。

![](assets/20200605202041549_13614.webp)
...
### 执行SQL
![](assets/20200605202552565_30459.webp)

下面介绍一些执行语句的操作。

点击**执行按钮**即可执行整个SQL文件，也可用F5快捷键。

![](assets/20200605202706004_8281.webp)

有时候只想执行一部分的SQL语句。这时可以选中这部分的语句，再点击执行按钮，即可只执行这部分的语句。

![](assets/20200605202857766_23266.webp)
...
### 查询数据
SQL语句中最重要的就是查询语句了，为了方便查询，先插入一些数据，这里使用数据库课程提供的[测试数据](data.sql)，仅供测试使用。

* 查询所有课程名称

`SELECT cname FROM course`

![](assets/20200605210615861_29748.webp)
...
![](assets/20200606082034881_4352.webp)

在对象资源管理器上右键点击已连接的实例，选择属性。

![](assets/20200606082128160_19586.webp)
...
![](assets/20200606083310575_23550.webp)

注意切换到SQL身份验证。

![](assets/20200606083350387_19852.webp)
...
![](assets/20200606083504269_3908.webp)
