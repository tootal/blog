...
## 斐波那契相关问题
对于其他和斐波那契数列相关的问题，如广义斐波那契数列、斐波那契数列前缀和等，这里归类为斐波那契相关问题。通常需要用到一些斐波那契数列的性质，参考文章：[斐波那契数_孙智宏](斐波那契数_孙智宏.pdf)。
...
对于一个给定的模数，如何求出循环节呢？利用枚举的方法显然太慢了，我们可以利用这篇论文：[The Period of the Fibonacci Sequence Modulo j.pdf](The%20Period%20of%20the%20Fibonacci%20Sequence%20Modulo%20j.pdf)中提到的一些性质来加速求解。
...
这题是之前小范围求循环节的加强版，质数的范围最大可以到$10^9$。可以再仔细阅读一下这篇论文：[The Period of the Fibonacci Sequence Modulo j.pdf](The%20Period%20of%20the%20Fibonacci%20Sequence%20Modulo%20j.pdf)。
...
参考论文：[PeriodRankOrderMMofficial.pdf](PeriodRankOrderMMofficial.pdf)
